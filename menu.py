...
while place_order:
        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    food_selected = menu_items[menu_selection]["Item name"]

                    # Ask the customer for the quantity of the menu item
                    quantity = input(f"How much of {food_selected} would you like to order? If the input is invalid, it will default to 1: ")
                ...
                # Tell the customer they didn't select a menu option
                    ...
                    print("You did not enter a valid menu option presented.")
            else:
                print(f"{menu_selection} was not a valid menu item number.")    
    ...
    while True:
        ...
        match keep_ordering:
            ...
            case _:
                print("Please try again, as you did not enter a valid input.")
